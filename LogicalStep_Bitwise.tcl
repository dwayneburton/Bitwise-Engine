...
if {[is_project_open]} {
	if {[string compare $quartus(project) "LogicalStep_Bitwise"]} {
		puts "Project LogicalStep_Bitwise is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists LogicalStep_Bitwise]} {
		project_open -revision LogicalStep_Bitwise_top LogicalStep_Bitwise
	} else {
		project_new -revision LogicalStep_Bitwise_top LogicalStep_Bitwise
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name SOURCE_FILE LogicalStep_Bitwise_top.vhd
	...
	set_global_assignment -name TCL_SCRIPT_FILE LogicalStep_Bitwise.tcl
